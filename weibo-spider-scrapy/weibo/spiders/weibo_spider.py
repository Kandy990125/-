...
class Weibo(Spider):
    ...
    for i in range(3,105):
        start_urls.append("https://m.weibo.cn/api/container/getIndex?containerid=100103type%3D1%26q%3D%E9%93%81%E8%B7%AF&page_type=searchall&page=" + str(i))  # 铁路
        start_urls.append("https://m.weibo.cn/api/container/getIndex?containerid=100103type%3D1%26q%3D%E9%AB%98%E9%93%81&page_type=searchall&page=" + str(i))  # 高铁
        start_urls.append("https://m.weibo.cn/api/container/getIndex?containerid=100103type%3D1%26q%3D%E9%93%81%E8%B7%AF&page_type=searchall&page=" + str(i))  # 铁道
        start_urls.append("https://m.weibo.cn/api/container/getIndex?containerid=100103type%3D1%26q%3D%E4%BA%A4%E9%80%9A&page_type=searchall&page=" + str(i))  # 交通
        #start_urls.append(
